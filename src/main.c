...
//	SystemInit();
	...
	for (int i=0;i<2;i++) // need to send twice in order to turn on the 1st one LED
	{
		delay_ms(10); // need to wait
	ws2812_framebuffer[0].red=255;
	ws2812_framebuffer[0].blue=0;
    ws2812_framebuffer[0].green=0;
	};
	dma_hold();
#if 0
	uint32_t pos_r = 40;
